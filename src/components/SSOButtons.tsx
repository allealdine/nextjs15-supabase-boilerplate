...
type Provider = "github" | "google" | "twitter" | "facebook" | "apple";
        ...
        {enabledProviders.map((provider) => {
          ...
          return (
            <button
              ...
              className={`hover:cursor-pointer group relative flex h-11 items-center rounded-md border ${config.borderColor} px-6 transition-colors duration-200 ${config.bgColor} ${config.textColor}`}
            >
