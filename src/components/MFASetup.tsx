          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <input
                ...
                className="mt-1 block w-full rounded-md border-gray-300 shadow-xs focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                placeholder="e.g., Work Phone, Personal iPhone"
                autoFocus
              />
              <p className="text-sm text-gray-500">
                Give this authentication method a name to help you identify it
                later
              </p>
            </div>
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                className="flex justify-center py-2 px-4 border border-transparent rounded-md shadow-xs text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50"
              >
